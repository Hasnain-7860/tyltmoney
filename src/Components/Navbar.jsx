  ...
  return (
    ...
    <div className='bg-white  h-[100vh] '>
     ...
     className='flex justify-between container'>
        ...
        <ul  className='flex flex-col mt-[5%] gap-5  w-[90vw] font-semibold   '>
          <li className='text-[20px]'><a href="">P2P EXCHANGE</a></li>
       <li className='text-[20px] flex  items-center justify-between  '><a href="">BUSINESS </a> <MdArrowForwardIos className='' /></li>
        <li className=' text-[20px] flex items-center justify-between'   ><a href=""> RESOURCES</a><MdArrowForwardIos/> </li>
        <li className='text-[20px]'><a href="">BLOG</a></li>
            <li className='text-[20px]'><a href="">REFERRAL</a></li>
